    ...
    async def create_checkout_session(self, cart_items: list) -> dict:
        ...
        try:
            params = {
                ...
                "shipping_address_collection[allowed_countries][8]":  "CH",
                "shipping_address_collection[allowed_countries][9]":  "LU",
                "shipping_address_collection[allowed_countries][10]": "DK",
                "shipping_address_collection[allowed_countries][11]": "LI",
            }
